...
# vopservice 新增包 直接用官方包替代
vopservice_normalConfig_v91_v10 = []
...
phone_recorder_normalConfig_v91_v10 = []
...
# 以当前文件夹为基础路径 ， 查找配置文件并替换 
configFileDic = listConfigFileArray();
# 检查文件是否存在  ， 如果不存在 ， 则需要一个默认的组件包 ， 或移除留空
...
# 开始替换
# 先替换 frameworkResHwextConfigFilePathList 
