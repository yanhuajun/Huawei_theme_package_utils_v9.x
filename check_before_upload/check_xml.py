...
def check(arr):
	...
	for item in arr:
		...
		if root == '' :
			print "something error ,check out then bottom log ...."
...
if len(errorXmlFilePathList) > 0 :
	print "these xml file error , check these out !!!!!"
	for item in errorXmlFilePathList:
		print "path:" + item 
else:
	print "all xml is ok"

print ".bat / .DS_Store file delete success \n xml file check over "
